...
A generic library without any dependencies intended for use with Monogame. Retromono.Signal provides Signal classes which behave almost like C#'s native events with a couple notable exceptions:
